...
def main():
    ...
    raw_url = "https://web.archive.org/web/20230312094223fw_/https://voca-st.com/circleList"
    ...
    for row in table_rows:
        ...
        remove_wbm = lambda s: s.replace("https://web.archive.org/web/20230312094223/", "").strip()
