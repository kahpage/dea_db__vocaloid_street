...
def main():
    ...
    raw_url = "https://web.archive.org/web/20210624083117id_/http://voca-st.com/circlelist"
    ...
    for row in table_rows:
        ...
        remove_wbm = lambda s: s.replace("https://web.archive.org/web/20210624083117/", "").strip()
