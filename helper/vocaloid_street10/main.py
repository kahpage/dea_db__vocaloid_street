...
def main():
    ...
    raw_url = "https://web.archive.org/web/20250215223553id_/https://voca-st.com/events/10/circleList"
    ...
    for table in tables:
        ...
        for row in table_rows:
            ...
            if len(cells) == 3:
                ...
                booth_name = sanitize_string(cells[1].get_text())
                web_tag = cells[2].select_one("a")
                if web_tag and web_tag.has_attr("href"):
                    url_ = (
                        web_tag["href"]
                        .replace("https://web.archive.org/web/20250215223553/", "")
                        .strip()
                    )
            ...
            remove_wbm = lambda s: s.replace(
                "https://web.archive.org/web/20250215223553/", ""
            ).strip()
